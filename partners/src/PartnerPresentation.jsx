...
const MoneyFlow = ({ amount, label, sub, color }) => (
  <div style={{ textAlign: 'center' }}>
    <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '48px', fontWeight: 800, color, lineHeight: 1 }}>{amount}</div>
    <div style={{ fontSize: '15px', fontWeight: 600, color: 'white', marginTop: '6px' }}>{label}</div>
    ...
    <div style={{ minHeight: '100vh', background: '#080810', fontFamily: "'DM Sans', 'Segoe UI', sans-serif", color: 'white', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <a href="https://мониторинг-вб.рф" style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: '18px', textDecoration: 'none' }}>
          ...
          <span style={{ color: '#34d399' }}>·ВБ</span>
        </a>
        <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
          ...
          <a href={CONTACT_LINK} target="_blank" rel="noreferrer" className="btn-glow" style={{
            padding: '10px 24px', background: 'linear-gradient(135deg, #34d399, #059669)',
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', padding: '140px 40px 80px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
          <div style={{ position: 'absolute', top: '10%', left: '0%', width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(52,211,153,0.12) 0%, transparent 70%)' }} />
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '8px 20px', background: 'rgba(52,211,153,0.1)', border: '1px solid rgba(52,211,153,0.25)', borderRadius: '100px', marginBottom: '32px', fontSize: '13px', color: '#34d399', fontWeight: 600 }}>
            ...
            <p style={{ fontSize: '19px', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, maxWidth: '600px', marginBottom: '48px' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '64px' }}>
              <a href={CONTACT_LINK} target="_blank" rel="noreferrer" className="btn-glow" style={{
                ...
                padding: '18px 40px', background: 'linear-gradient(135deg, #34d399, #059669)',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', width: '100%', maxWidth: '700px' }}>
              {[
                { n: '40%', l: 'с каждой оплаты', c: '#34d399' },
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <FadeIn>
            <div style={{ textAlign: 'center', marginBottom: '72px' }}>
              <div style={{ fontSize: '12px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#34d399', marginBottom: '14px', fontWeight: 600 }}>Механика</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {[
              { n: '01', icon: '📝', title: 'Заполните заявку', desc: 'Зарегистрируйтесь в партнёрской программе, заполнив короткую форму. После одобрения вы получаете личный кабинет.', color: '#34d399' },
          ...
          {/* MAX channel bonus */}
          <FadeIn delay={0.2}>
            <div style={{ marginTop: '24px', background: 'linear-gradient(135deg, rgba(52,211,153,0.12), rgba(5,150,105,0.06))', border: '1px solid rgba(52,211,153,0.25)', borderRadius: '20px', padding: '32px', display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
              <div style={{ fontSize: '36px', flexShrink: 0 }}>🌟</div>
              <div>
                <div style={{ fontWeight: 700, fontSize: '18px', marginBottom: '8px', color: '#34d399' }}>Бонус для владельцев каналов в MAX</div>
      ...
      {/* EARNINGS CALCULATOR */}
      <section id="earnings" style={{ padding: '100px 40px', background: 'rgba(255,255,255,0.02)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <FadeIn>
            <div style={{ textAlign: 'center', marginBottom: '72px' }}>
              <div style={{ fontSize: '12px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#34d399', marginBottom: '14px', fontWeight: 600 }}>Доход</div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.45)', marginTop: '16px', fontSize: '16px' }}>Подписка 400 ₽ · Ваша доля 40% = 160 ₽ за каждую оплату</p>
            </div>
          </FadeIn>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
            {[
              { users: 100, label: '100 активных пользователей', monthly: '16 000 ₽', yearly: '192 000 ₽', color: '#34d399', tag: 'Старт' },
              ...
              <FadeIn key={tier.users} delay={i * 0.1}>
                <div className="card-h" style={{
                  ...
                  <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '24px' }}>{tier.label}</div>
                  <div>
      ...
      <section style={{ padding: '100px 40px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <FadeIn>
            <div style={{ textAlign: 'center', marginBottom: '72px' }}>
              <div style={{ fontSize: '12px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#34d399', marginBottom: '14px', fontWeight: 600 }}>Личный кабинет</div>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <FadeIn>
            <div style={{ textAlign: 'center', marginBottom: '56px' }}>
              <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(28px, 3.5vw, 44px)', fontWeight: 800, letterSpacing: '-0.03em' }}>Кому подойдёт партнёрство?</h2>
            </div>
          </FadeIn>
      ...
      <section style={{ padding: '100px 40px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          <FadeIn>
            <div style={{ background: 'linear-gradient(135deg, #064e3b, #065f46, #047857)', borderRadius: '32px', padding: '64px 48px', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <a href={CONTACT_LINK} target="_blank" rel="noreferrer" className="btn-glow" style={{
                  ...
                  fontSize: '16px', fontWeight: 800, color: '#064e3b', textDecoration: 'none'
                }}>
                  🤝 Подать заявку
                </a>
